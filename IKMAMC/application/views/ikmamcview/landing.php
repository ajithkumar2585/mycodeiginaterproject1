...
<html lang="en">
   ...
   <body class="main-layout">
      <!-- loader  -->
      <div class="loader_bg">
         <div class="loader"><img src="<?php echo base_url();?>/Designs/images/loading.gif" alt="#"/></div>
      </div>
      <!-- end loader -->
      <!-- header -->
      ...
      <div id="about" class="about">
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-7">
                  <div class="about_img">
                     <figure><img src="<?php echo base_url();?>/Designs/images/about.png" alt="#"/></figure>
                  </div>
               </div>
            </div>
         </div>
                  ...
                  <div class="row">
                     <div class="col-md-4 col-sm-6">
                        <div class="service_box">
                           <i><img src="<?php echo base_url();?>/Designs/images/service1.png" alt="#"/></i>
                           <h3>Retina Ready</h3>
                     ...
                     <div class="col-md-4 offset-md-1 col-sm-6">
                        <div class="service_box">
                           <i><img src="<?php echo base_url();?>/Designs/images/service2.png" alt="#"/></i>
                     ...
                     <div class="col-md-4 offset-md-3 col-sm-6 mar_top">
                        <div class="service_box">
                           <i><img src="<?php echo base_url();?>/Designs/images/service3.png" alt="#"/></i>
                           <h3>Easy-to-Use</h3>
                           <p>many variations of passages <br>of Lorem Ipsum available,</p>
                        </div>
                     </div>
                     <div class="col-md-4 offset-md-1 col-sm-6 mar_top">
                        <div class="service_box">
                           <i><img src="<?php echo base_url();?>/Designs/images/service4.png" alt="#"/></i>
                           <h3>Easy Import</h3>
                           <p>many variations of passages <br>of Lorem Ipsum available,</p>
                        </div>
                     </div>
            ...
            <div class="row">
               ...
               <div class="col-md-4 col-sm-6">
                  <div class="gallery_img">
                     <figure><img src="<?php echo base_url();?>/Designs/images/gallery1.jpg" alt="#"/></figure>
                  </div>
               </div>
               <div class="col-md-4 col-sm-6">
                  <div class="gallery_img">
                     <figure><img src="<?php echo base_url();?>/Designs/images/gallery2.jpg" alt="#"/></figure>
                  </div>
               </div>
               <div class="col-md-4 col-sm-6">
                  <div class="gallery_img">
                     <figure><img src="<?php echo base_url();?>/Designs/images/gallery3.jpg" alt="#"/></figure>
                  </div>
               </div>
               <div class="col-md-4 col-sm-6">
                  <div class="gallery_img">
                     <figure><img src="<?php echo base_url();?>/Designs/images/gallery4.jpg" alt="#"/></figure>
                  </div>
               </div>
               <div class="col-md-4 col-sm-6">
                  <div class="gallery_text">
               ...
               <div class="col-md-4 col-sm-6">
                  <div class="gallery_img">
                     <figure><img src="<?php echo base_url();?>/Designs/images/gallery5.jpg" alt="#"/></figure>
                  </div>
               </div>
               <div class="col-md-4 col-sm-6">
                  <div class="gallery_img">
                     <figure><img src="<?php echo base_url();?>/Designs/images/gallery6.jpg" alt="#"/></figure>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="row d_flex">
               ...
               <div class="col-md-7 pad_roght0">
                  <div class="design_img">
                     <figure><img src="<?php echo base_url();?>/Designs/images/desi.jpg" alt="#"/></figure>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="row">
               <div class="col-md-4 offset-md-2">
                  <div id="new" class="news_box">
                     <div class="news_img">
                        <figure><img src="<?php echo base_url();?>/Designs/images/blog1.jpg" alt="#"/></figure>
                     </div>
                     <div class="news_room">
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="text_humai">
                                          <i><img src="<?php echo base_url();?>/Designs/images/tett1.png" alt="#"/></i>
                                    ...
                                    <div class="col-md-6">
                                       <div class="text_humai">
                                          <i><img src="<?php echo base_url();?>/Designs/images/tett2.png" alt="#"/></i>
                                          <span>HumouThere</span>
                                          <p>T suffered alteration in some form, by injected humouThere are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humou</p>
                                       </div>
                                    </div>
